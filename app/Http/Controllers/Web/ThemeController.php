...
class ThemeController extends Controller
{
	...
	public function theme()
	{
		...
		$header = $this->setHeader($header_id, $commonContent);
		$mobileheader = $this->mobileHeader($commonContent);
		$carousel = $this->setCarousal($carousel_id, $commonContent);
		$banner = $this->setBanner($banner_id, $commonContent);
		$footer = $this->setFooter($footer_id, $commonContent);
	...
	private function setTopOffer($commonContent = null)
	{
		$index = new Index();
	...
	private function setHeader($header_id, $commonContent = null)
	{
		$index = new Index();
	...
	private function mobileHeader($commonContent = null)
	{
		$index = new Index();
		$languages = new Languages();
		$products = new Products();
	...
	private function setCarousal($carousel_id, $commonContent = null)
	{
		$languages = new Languages();
		$products = new Products();
		$currencies = new Currency();
	...
	private function setBanner($banner_id, $commonContent = null)
	{
		$index = new Index();
		if($commonContent == null) {
			$result['commonContent'] = $index->commonContent();
	...
	private function setFooter($footer_id, $commonContent = null)
	{
		$index = new Index();
		$newss = new News();
		$products = new Products();
	...
	private function mobileFooter($commonContent = null)
	{
		$index = new Index();
		if($commonContent == null) {
			$result['commonContent'] = $index->commonContent();
